...
echo "     - Add your code repositories"
echo "     - Click 'Initialize' to start analysis"
echo ""
echo "  3. Connect Claude Code to your project's graph:"
echo "     Add to your repo's .mcp.json (shown in Dashboard > Settings)"
echo ""
echo "════════════════════════════════════════════════════"
echo ""
